...
---
- 🎓 Final-year B.Tech in Computer Science Engineering student focused on Software Engineering, Backend Development, and Cloud Technologies | CGPA: 8.40

- 🔭 Building Java and Python applications while exploring backend systems, distributed systems, and scalable software architecture

- ☁️ Hands-on experience building web and cloud-based applications using AWS, Firebase, REST APIs, Docker, and MySQL

- 🔗 Built a decentralized peer-to-peer file-sharing system using Python, Flask, AES-256 encryption, IPFS storage, blockchain logging, and Docker

- 💬 Developed a real-time multi-client chat application using Java, TCP socket programming, and multithreading

- 🤖 Built an IoT-based EMG muscle strain and posture monitoring system using ESP32, EMG sensors, Firebase, and real-time alerts

- 🌐 Interested in Full-Stack Development, Cloud Computing, Distributed Systems, Computer Networking, and IoT

- 💻 Comfortable with Java, Python, C++, JavaScript, React, Flask, AWS, Firebase, MySQL, Git, Docker, and REST APIs

- 🧠 Exploring AI-assisted development and learning how to use AI prompting and modern tools effectively in software development workflows

- 📚 Currently strengthening Advanced Java, Data Structures & Algorithms, System Design, Backend Development, and Cloud Computing skills

- 🚀 Open to Software Engineer, Backend Developer, Full-Stack Developer, Cloud/DevOps, and entry-level AI Engineering opportunities

- 🌍 Available for opportunities in India and remote opportunities worldwide

- 📫 Email: **suyashsingh2109@gmail.com**

- ⚡ Fun fact: I enjoy turning ideas into working projects and learning by building real systems rather than only studying theory
---
