...
- 🎓 Final-year B.Tech Computer Science Engineering student with a CGPA of 8.40.

- 💻 Interested in Software Engineering, Backend Development, Cloud Computing, and Distributed Systems.

- 🔭 Building applications using Java, Python, Flask, React, AWS, Docker, Firebase, and MySQL.

- 🤖 Currently working on Generative AI projects and exploring LLMs, AI applications, and modern AI-powered software development.

- 🌍 Open to Software Engineer opportunities in India and remote opportunities worldwide.
